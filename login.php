         ...
         <div class="card-body">
             ...
             <form id="loginForm" action="user.php" method="post" autocomplete="on">
                 <div class="form-group row">
                     ...
                     <div class="col-xl-9">
                         <input name="loginEmail" type="email" class="form-control" id="loginMail"
                                placeholder="Email">
                     </div>
                 </div>
                 <div class="form-group row">
                 ...
                 <div class="form-group row">
                     <div class="col-xl-9 offset-xl-3 d-flex">
                         ...
                         <button type="submit" formaction="login.php" class="btn btn-info">Créer votre compte
                         </button>
                     </div>
         ...
         <div class="card-body">
             ...
             <form id="newUserForm" action="user.php" method="post" autocomplete="on">
                 ...
                 <div class="form-group row">
                     ...
                     <div class="col-xl-9">
                         <input name="confirmation" type="password" class="form-control" id="confirmation"
                                placeholder="Confirmation">
                     </div>
                 </div>
                 <div class="form-group row">
                     <div class="col-xl-9 offset-xl-3 d-md-flex">
                         <button type="submit" formactin="user.php" class="btn btn-success mr-1" disabled>Créer votre compte
                         </button>
                         <button formaction="login.php" name="connected" type="submit" id="loginButton"
                                 class="btn btn-info">Se connecter
                         </button>
                     </div>
                 </div>
             </form>
